...
export default {
  ...
  data () {
    return {
      ...
      notEqualErrorLabel: 'Senhas devem ser iguai',
      passwordErrorLabel: 'Senha é obrigatória',
      nameErrorLabel: 'Nome é obrigatório',
      emailErrorLabel: 'E-mail é obrigatório',
      emailNotValidLabel: 'Email inválido',
      name: '',
      email: '',
      password: '',
      repeatPassword: '',
